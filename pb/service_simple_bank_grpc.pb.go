...
type SimpleBankClient interface {
	...
	GetAllUser(ctx context.Context, in *NoParameterRequest, opts ...grpc.CallOption) (*GetAllUserResponse, error)
}
...
func (c *simpleBankClient) GetAllUser(ctx context.Context, in *NoParameterRequest, opts ...grpc.CallOption) (*GetAllUserResponse, error) {
	out := new(GetAllUserResponse)
	err := c.cc.Invoke(ctx, "/pb.SimpleBank/GetAllUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleBankServer interface {
	...
	GetAllUser(context.Context, *NoParameterRequest) (*GetAllUserResponse, error)
...
func (UnimplementedSimpleBankServer) GetAllUser(context.Context, *NoParameterRequest) (*GetAllUserResponse, error) {
...
func _SimpleBank_GetAllUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.SimpleBank/GetAllUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).GetAllUser(ctx, req.(*NoParameterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
